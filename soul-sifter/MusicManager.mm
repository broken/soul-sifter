...
- (Song *)discoverSong:(NSURL *)musicFile {
    ...
    while (NULL != (frame = iter->GetNext())) {
            ...
            case ID3FID_POPULARIMETER:
        {
            ...
            << nCounter << " rating=" << nRating << std::endl;
                    delete [] sEmail;
                break;
            }
            ...
            case ID3FID_SYNCEDLYRICS:
            {
                ...
                *sLang = ID3_GetString(frame, ID3FN_LANGUAGE);
                ...
                switch (nRating)
                {
                    case ID3CT_OTHER:    std::cout << "Other"; break;
                    case ID3CT_LYRICS:   std::cout << "Lyrics"; break;
                    case ID3CT_TEXTTRANSCRIPTION:     std::cout << "Text transcription"; break;
                    case ID3CT_MOVEMENT: std::cout << "Movement/part name"; break;
                    case ID3CT_EVENTS:   std::cout << "Events"; break;
                    case ID3CT_CHORD:    std::cout << "Chord"; break;
                    case ID3CT_TRIVIA:   std::cout << "Trivia/'pop up' information"; break;
                }
                std::cout << std::endl;
